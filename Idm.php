...
{
echo @color('red',"Script Expired, Hubungi Creator https://wa.me/6283866254378\n");
...
echo @color('green',"  | WA 083866254378 \n");
echo @color('yellow',"        Build By Farhan\n");
...
$d4 = str_replace("-","", $d3);
    ...
    echo @color('nevy'," Silahkan Hubungi Creator Untuk Verifikasi https://wa.me/6283866254378\n\n");
    @unlink("chace");
    d1("chace", $d4);
    @unlink("chrome");
    goto keygen;
...
$timestamp = date("d-m-Y | H:i:s");
echo $timestamp;
echo @color('red'," -Build By Silence Is No Gold-");
echo @color('yellow',"\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
echo "\n";
...
$namlas=@$ind["data"]["content"][15]["couponCode"];
$dlas=@$ind["data"]["content"][16]["couponName"];
$dlasd=@$ind["data"]["content"][16]["couponCode"];
$dellas=@$ind["data"]["content"][17]["couponName"];
$dellasd=@$ind["data"]["content"][17]["couponCode"];
echo "\n";
...
echo @color('green',"[17] $dlas \n    > $dlasd \n\n");
echo @color('green',"[18] $dellas \n    > $dellasd \n\n");
if($m == "issued"){
...
$bisaddddddddd = str_replace("/","", $pitubel);
...
save (''.$bisaddddddddd.'.txt', $dlasd);
save (''.$bisadddddddddd.'.txt', $dellasd);
sleep(2);
echo "\n";
}
else if($vv == ''){
    ...
    echo @color('nevy'," |    Auto Regist Klik \n");
    echo @color('green',".           SILENCE IS NO GOLD \n");
    echo @color('nevy',"                    CUAN HUNTER  \n");
...
$farhan=@$sayang["ResponseObject"]["status"];
$sing=@$sayang["ResponseObject"]["keterangan"];
